...
<body>
   ...
   <div class="pageback p-xs-0 p-sm-0 p-md-0 p-l-0 p-xl-5">
      <div class="titrepage">
         <h2 class="d-flex mx-3 mt-3 mb-5">Annonce en detail</h2>
      </div>
      <!-- SECTION ANNONCE -->
      <div class="sectionannonces d-flex flex-wrap col-12 p-xl-5">
         ...
         <div class="annonce col-12">
            ...
            <div class="annonceiddem d-flex">
               ...
               <h3 class="ps-2 d-flex align-items-center">Nom du demandeur de projet</h3>
            </div>
            ...
            <div class="annoncedescriptif p-5">
               <p>Integer nibh libero, tincidunt a ultrices dignissim, pretium non mi. Praesent vitae aliquet turpis, quis faucibus leo. Praesent eleifend tortor eget velit aliquam, ut faucibus elit sagittis. Nullam nec sapien eget nisi pellentesque pellentesque sit amet at ex. Praesent lacus neque, condimentum at pretium nec, convallis a libero. Proin non metus aliquet, commodo risus in, ornare dolor. Morbi dictum nisi mi, vel convallis nibh convallis ac. Duis condimentum at turpis eu gravida.<br>
                  ...
                  Lorem ipsum dolor sit amet, consectetur adipiscing elit. Proin convallis vel nisi ut convallis. Morbi ac nibh odio. Pellentesque mollis condimentum varius. Vivamus lobortis maximus augue eu dapibus. Donec rhoncus fermentum magna. Curabitur malesuada, magna sit amet fermentum volutpat, nulla magna fermentum enim, vestibulum vestibulum diam arcu bibendum lacus. Cras ultricies malesuada posuere. Cras id commodo mauris, id efficitur massa. Vivamus egestas lorem eget leo ultricies, in mollis purus auctor. Vivamus sed nunc aliquam, porttitor nunc bibendum, auctor odio. Integer vulputate ante ut erat venenatis, vitae posuere neque hendrerit. Maecenas sollicitudin erat sit amet neque vestibulum interdum. Curabitur eu metus augue.
               </p>
            </div>

            <!-- CRUD CANDIDATURE -->

            <div class="candidature p-5">
               <h3 class="ps-2 d-flex align-items-center">Répondre à cette annonce</h3>
               <form action="./scripts/candidature_mission.php" method="POST">
