...
<body>
    ...
    <div class="pageback px-sm-1 px-xl-4 py-5">
        ...
        <div class="d-md-flex m-auto col-lg-8">
            <!-- gauche -->
            <div class="boxpurple m-auto p-4 col-lg-4">
                ...
                ?>
                <?php
                echo "<p> <b>Activité : </b>" . $_SESSION['job'] . "</p>";
                ?>

            </div>
            <!-- droite -->
            <div class="boxwhite align-items-start m-auto p-4 col-lg-8">
                <h2>Créez une description</h2>
                <form action="./scripts/modifProfil_free.php" method="post">
                    <textarea class="form-control" rows="5" name="description">
                        ...
                        if(!empty($_SESSION['description'])) {
                            ...
                            echo 'Veuillez écrire votre descrption';
                        }?>
                        </textarea>
        ...
        <div class="boxwhite d-flex flex-column align-items-start m-auto p-4 col-lg-8">
            ...
            <div class="row w-100">            
                <div class="col-md-6 col-12 mb-5">
                    <form action="./scripts/modifMail_free.php" method="post">
                ...
                <div class="col-md-6 col-12 mb-5">
                    <form action="./scripts/modifPseudo_free.php" method="post">
            ...
            <form action="./scripts/modifMDP_free.php" method="post">
                <div class="row mb-5">
            ...
            <div class="d-flex">
                <span class="material-symbols-outlined">
                    cancel</span>
                <a href="./scripts/supprrCompte_free.php">Supprimer mon compte</a>
            </div>
        </div>
    </div>
    <!-- FOOTER -->
